...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 flex w-[420px] max-w-[90vw] -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-xl border border-border bg-white p-6 shadow-2xl focus-visible:outline-none",
        className
      )}
      {...props}
    >
